...
class User(Base):
    ...
    assets = relationship("Asset", back_populates="owner", cascade="all, delete-orphan") # Añadido cascade
    transactions = relationship("Transaction", back_populates="owner", cascade="all, delete-orphan") # Añadido cascade
...
class Asset(Base):
    ...
    transactions = relationship("Transaction", back_populates="asset", cascade="all, delete-orphan") # Añadido cascade
...
class Transaction(Base):
    ...
    def __repr__(self):
        ...
        return f"<Transaction(type='{self.transaction_type.name}', asset_id={self.asset_id}, qty={self.quantity}, price={self.price_per_unit}, total={total})>"

# print("Modelos User, Asset y Transaction definidos.") # Comentado para limpieza